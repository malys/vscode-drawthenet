...
suite("Macros Tests", () => {
    const docUri = getDocUri('test.yaml');

    test("Completes macros in yaml file", async () => {
    ...
    test("Provide macro signature help at ( in yaml file", async () => {
    ...
    test("Provide macro signature help in the middle in yaml file", async () => {
