# VSCode DrawTheNet Changelog

## 2.9.1

- Improvement: Show digram errors reported by drawthenet server, solve [#148](https://github.com/qjebbs/vscode-drawthenet/issues/148)
- Improvement: 'jar' setting now in resource scope, you can use different jar settings for different workspace folders. solve [#147](https://github.com/qjebbs/vscode-drawthenet/issues/147)


## 2.9.0

- New Feature: Initial support of [Macros](http://drawthenet.com/preprocessing) IntelliSense (Code Completion & Signature Prompt). 
Thanks [Ricardo Niepel](https://github.com/RicardoNiepel) for the great work..

## 2.8.6

- Fix: Fix preview drag in 1.26.0, solve [#141](https://github.com/qjebbs/vscode-drawthenet/issues/141)
- Code optimize.
...
- Improvement: Multi-page export file names optimize, solve [#134](https://github.com/qjebbs/vscode-drawthenet/issues/134)

## 2.8.3

- Disable formatter if formatOnSave is on, solve [#130](https://github.com/qjebbs/vscode-drawthenet/issues/130)
...
> Use `drawthenet.previewSnapIndicators` to control the indicators visibility.

## 2.8.0

- New Feature: Snap to Bottom/Right, resolves [#128](https://github.com/qjebbs/vscode-drawthenet/issues/128)
...
- Improvement: Add ";" to snippets prefixes to avoid typing conflict, solve [#124](https://github.com/qjebbs/vscode-drawthenet/issues/124)
...
- Fix: Restart watching after preview is closed by VSCode, resolve [#89](https://github.com/qjebbs/vscode-drawthenet/issues/89).
...
- Fix: If-else format, resolve [#116](https://github.com/qjebbs/vscode-drawthenet/issues/116).

## 2.5.11

- Fix: No diagram tip on first open preview, resolve [#115](https://github.com/qjebbs/vscode-drawthenet/issues/115).
- Code optimize.

## 2.5.10

- Update embedded default drawthenet.jar

## 2.5.9

- Improvement: Configurable Java executable path, resolve [#72](https://github.com/qjebbs/vscode-drawthenet/issues/72), [#112](https://github.com/qjebbs/vscode-drawthenet/issues/112)
- Update traditional chinese translation.
- Fix: Graphviz download url. Thanks [binderclip](https://github.com/binderclip).

## 2.5.8

- Fix: Calc auto include for no-current-workspace file, resolve [#110](https://github.com/qjebbs/vscode-drawthenet/issues/110)
- Improvement: Error catch optimize
- Code optimize.

## 2.5.7

- Fix: Read config for unsaved file issue, resolve [#109](https://github.com/qjebbs/vscode-drawthenet/issues/109)
...
[#99](https://github.com/qjebbs/vscode-drawthenet/issues/99)
[#100](https://github.com/qjebbs/vscode-drawthenet/issues/100)
[#101](https://github.com/qjebbs/vscode-drawthenet/issues/101)
[#102](https://github.com/qjebbs/vscode-drawthenet/issues/102)
- Improvement: Treat entire diagram file as a diagram, if not `@startxxx` is given, solve [#91](https://github.com/qjebbs/vscode-drawthenet/issues/91)

## 2.5.4

- Improvement: Add setting `jarArgs`, solve [#97](https://github.com/qjebbs/vscode-drawthenet/issues/97)
- Improvement: Remove error text display below the preview image.
- Fix: Some syntax highlight fix, solve [#83](https://github.com/qjebbs/vscode-drawthenet/issues/83), [#96](https://github.com/qjebbs/vscode-drawthenet/issues/96)

## 2.5.3

- Improvement: Syntax highlight for DrawTheNet code inside Markdown. Thanks to [cazeaux](https://github.com/qjebbs/vscode-drawthenet/pull/95).
- Code optimize.

## 2.5.2

- Improvement: Lazy check java, solve [#93](https://github.com/qjebbs/vscode-drawthenet/issues/93)

## 2.5.1

- Fix: Incorrect logic for source scope settings, [#90](https://github.com/qjebbs/vscode-drawthenet/issues/90)
...
- Update embeded `drawthenet.jar` to latest.
- Some optimizations.
- Bug fixes & Code optimizations.

Thanks [arnaudroques](https://github.com/arnaudroques) for working on `drawthenet.jar` for these features.

## 2.3.3

- Fix: 
[#68](https://github.com/qjebbs/vscode-drawthenet/issues/68), 
[#74](https://github.com/qjebbs/vscode-drawthenet/issues/74). 
...
[#70](https://github.com/qjebbs/vscode-drawthenet/issues/70), 
[#73](https://github.com/qjebbs/vscode-drawthenet/issues/73)

## 2.3.1

- Change diagram default name rule, resolve [#69](https://github.com/qjebbs/vscode-drawthenet/issues/69)
...
- Fix: Autoupdate not work on unsaved, fix [#65](https://github.com/qjebbs/vscode-drawthenet/issues/65)

## 2.2.2

- Fix: Incorrect initial zoom level when preview image is small
- Improvement: Target not changed when move cursor to none-diagram area, resolve [#62](https://github.com/qjebbs/vscode-drawthenet/issues/62)

## 2.2.1

- Improvement: Add sequence grouping formatting. Fix [#60](https://github.com/qjebbs/vscode-drawthenet/issues/60)
- Fix: Apostrophe syntax highligting. [#59](https://github.com/qjebbs/vscode-drawthenet/issues/59)
...
- Code optimize, try to fix [#54](https://github.com/qjebbs/vscode-drawthenet/issues/54)
...
- Improvement: Add ja translation
- Update intergrated drawthenet.jar

Give up inline formatting, because DrawTheNet is too flexible. So ~~`drawthenet.experimental.formatInLine`~~ has been removed.
...
- New Feature: Users are allowed to choose their render, which applied to both preview and export. In other words, users can get **15X times faster export** by utilizing DrawTheNet Server as render.
...
- `drawthenet.previewFromUrlServer` has been replaced by `drawthenet.render`
- `drawthenet.urlServer` has been renamed to `drawthenet.server`
- `drawthenet.urlServerIndexParameter` has been renamed to `drawthenet.serverIndexParameter`
...
- Fix: Preview form server, and add multipage support to it. Thanks to [Martin Riedel](https://github.com/qjebbs/vscode-drawthenet/pull/45).
...
- New Feature: Preview through DrawTheNet server. Thanks to [Martin Riedel](https://github.com/qjebbs/vscode-drawthenet/pull/34).
...
- New Feature: Add setting `drawthenet.jar` which allows you use your own jar (maybe a newer version, or with many dependent jars).
- Fix: Many syntax highlights fixes.

## 1.5.0

- New Feature: Zoom & scroll in preview. [#18](https://github.com/qjebbs/vscode-drawthenet/issues/18)
- New Feature: Export selected workspace file in exploer panel.
- New Feature: Add setting `drawthenet.fileExtensions` which allows you add your own extensions so as to export diagrams in source code files, like ".java".
...
- New snippets, cover all type diagrams. Modified from [zhleonix](https://github.com/zhleonix) / [vscode-drawthenet-ext](https://github.com/zhleonix/vscode-drawthenet-ext/blob/r1.0.0/snippets/snippets.json) with many fixes.
- Fix: Invalid characters are not fully cleared in export file name. [#17](https://github.com/qjebbs/vscode-drawthenet/issues/17)
...
- Improvement: Preview don't show when no diagram found in document. Resolve [#7](https://github.com/qjebbs/vscode-drawthenet/issues/7).
- Fix: "note top|bottom of" highlight. fix [#8](https://github.com/qjebbs/vscode-drawthenet/issues/8).
...
- New Feature: Add context menus for DrawTheNet file.
...
- Improvement: Support naming diagram when diagram starts and resolve [#2](https://github.com/qjebbs/vscode-drawthenet/issues/2)
...
- Improvement: export workspace diagrams will be organized in a directory named with "out" by default. you can changed directory name with setting `drawthenet.exportOutDirName`.

## 1.1.0

- New Feature: Export workspace diagrams
- Add more suffixes: ".iuml", ".drawthenet"
- Small improvements
- Changed command name and display

## 1.0.5

- `drawthenet.exportFormat` default is not set, user may pick one format everytime exports. You can still set a format for it if you don't want to pick. Setting enumeration added.
...
- Bug Fix: Remove excess "DrawTheNet:" display in Command Palette
